...
n = $m.row_size - 1
n.times do |i|
  slices << diagonal(0,i,:forward)
  slices << diagonal(0,i,:backward)
  slices << diagonal(i,0,:forward)
  slices << diagonal(i,n,:backward)
end
